    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="">MAK</a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div id="submenu-1" class="collapse submenu">
                                        <ul class="nav flex-column">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="Gestion.php">Gestión</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                            ...
                            <?php if ($_SESSION['roles'] === 1 || $_SESSION['roles'] === 2) { ?>
                                <li class="nav-item">
                                    ...
                                    <div id="submenu-1" class="collapse submenu">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link" href="Plantilla.php">Plantilla Gastos</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="PlantillaI.php">Plantilla Ingresos</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="Gestion.php">Gestión</a>
                                            </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <div id="submenu-2" class="collapse submenu">
                                        ...
                                        <?php if ($_SESSION['roles'] === 1 || $_SESSION['roles'] === 2) { ?>
                                            ...
                                            <ul class="nav flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link" href="AperturaCaja.php">Apertura de Caja</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="CierreCajaFinal.php">Validacion de Cierre de Caja</a>
                                                </li>
                                            </ul>
                                            <!-- CONTABILIDAD -->
                                        <?php } ?>
                                        ...
                                        <ul class="nav flex-column">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="CierreCaja.php">Cierre de Caja</a>
                                            </li>
                                        </ul>
                                        <!-- CAJA -->
                                        <!-- <?php } ?> -->
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-7" aria-controls="submenu-7"><i class="fas fa-fw fa-inbox"></i>Listado<span class="badge badge-secondary"></span></a>
                                <div id="submenu-7" class="collapse submenu">
                                    <ul class="nav flex-column">

                                        <li class="nav-item">
                                            <a class="nav-link" href="Caja-Custom.php">Caja</a>
                                        </li>

                                        <?php if ($_SESSION['roles'] === 3 || $_SESSION['user_'] !== 'rvalera') { ?>
                                            <?php if ($_SESSION['user_'] !== 'rvalera') { ?>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="Caja-Semanal.php">Caja Semanal</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="Caja-Diaria.php">Caja Diaria</a>
                                                </li>
                                            <?php } else {
                                            } ?>
                                        <?php } ?>
                                        ...
                                        <a class="nav-link" href="Caja-Completa.php">Caja Completa</a>
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <div id="submenu-1-2" class="submenu collapse">
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item">
                                                            <a class="nav-link" href="IngresosCaja.php">Ingresos</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" href="AdicionalesCaja.php">Adicionales</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" href="Diferencias.php">Diferencias</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </li>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Gestion de Caja MAK </h2>
                        ...
                        <img src="https://i.ytimg.com/vi/7GIfBx5BcI8/maxresdefault.jpg" alt="no se que poner xd" hidden>
                    </div>
                    <!-- ============================================================== -->
                    <!-- end pageheader  -->
                    <!-- ============================================================== -->
                    <div class="ecommerce-widget" hidden>
