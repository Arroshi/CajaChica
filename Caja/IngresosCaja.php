...
<body>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Listado de las aperturas</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <form class="card-header p-0">
                                <div class="form-row card-body">
                                    <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                        ...
                                        <select class="form-control" id="id_caja_cstm_ingr" name="id_caja_cstm_ingr">
                            ...
                            <?php
                            require_once('../Controller/controller_selector.php');
                            $list_ingreso_user = $oCaja->cajaIngreso();
                            ?>
                            ...
                            <div id="diff_" class="card-body">
                                <table id="table" class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <?php foreach ($list_ingreso_user as $lst_i_u) :
                                            $cont = 0;
                                        ?>

                                            <tr>
                                                <?php showdata($lst_i_u[$cont++]) ?>
                                                <?php showdata($lst_i_u[$cont++]) ?>
                                                <?php showdata("S/. " . $lst_i_u[$cont++]) ?>
                                                <?php showdata($lst_i_u[$cont++]) ?>
                                            </tr>
                                        <?php endforeach ?>
                                    </tbody>
    ...
    <script>
        $(document).ready(function() {
            ...
            // $('#id_caja_cstm_ingr').change(function() {
            //     if ($('#id_caja_cstm_ingr').val() == 'Selecciona') {
    ...
    <script>
        $("#id_caja_cstm_ingr").change(function() {
            var _data_diff_ing = {
                id_caja_cstm_ing: true,
                id_caja_cstm_ingr: $("#id_caja_cstm_ingr").val(),
            };
