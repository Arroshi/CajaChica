...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Gestión de gastos</h5>
                            ...
                            <form id="formCajaCustom" class="card-header p-0" method="POST">
                                <div class="form-row card-body">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12 mt-4">
                                        <button type="submit" class="btn btn-primary" id="btnFilterDate_admin" name="btnFilterDate_admin">Buscar</button>
                            ...
                            <div id="table_custom" class="card-body">
                                ...
                                $listaGestion = $oCaja->gestionCaja();
                                ?>
                                <table id="table" class="table resultadoFiltro table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Sub Sub Partida:</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($listaGestion as $lst_s) : ?>
                                            <tr>
                                                ...
                                                <td><?php echo $lst_s[10] ?></td>
                                                <!-- <?php
                                                        $signo = ($lst_s[6] === '1') ? "S/. " : "$/. ";
                                                        ?>
                                                <td>
                                                    <?php
                                                    if ($lst_s[7] !== null && $lst_s[7] !== '') {
                                                        echo $signo . $lst_s[7];
                                                    } else {
                                                        echo '- -';
                                                    }
        ...
        <script>
            $("#btnFilterDate_admin").click(function() {
                var _data_filter = {
                    btnFilterDate_admin: true,
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.resultado == 1) {
                            ...
                            $.each(data.listaCustom_admin, function(index, item) {
                                var row = "<tr>";
                                row += "<td>" + (item[0] ?? '') + "</td>";
                                row += "<td>" + (item[1] ?? '') + "</td>";
                                ...
                                row += "<td>" + (item[9] ?? '') + "</td>";
                                row += "<td>" + (item[10] ?? '') + "</td>";
                                // var tipoCambio = (item[9] === '1') ? "S/. " : "$/. ";
                                // var cambio = (item[10] !== null) ? tipoCambio + item[10] : '- -';
                                // row += "<td>" + cambio + "</td>";
                                // var cambio_ = (item[11] !== null) ? tipoCambio + item[11] : '- -';
                                // row += "<td>" + cambio_ + "</td>";
