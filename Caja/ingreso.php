...
<body>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form id="form_valor" method="POST">

                                    <div class="col-md-6 m-auto">


                                        <input type="hidden" id="usu_reg_id" name="usu_reg_id" value="<?php echo $_SESSION['id_cuenta'] ?>">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="custom-file mb-3">
                                                    ...
                                                    <input type="file" id="customFile" name="customFile[]" accept=".png, .jpg, .jpeg" hidden>
                                    ...
                                    <div class="col col-sm-10 col-lg-9 m-auto pt-3 text-right">
                                        <button type="button" id="btnCaja_add" name="btnCaja_add" class="btn btn-space btn-primary">Registrar</button>
                                        <button type="reset" id="btnCaja_add_cancel" class="btn btn-space btn-secondary">Cancel</button>
                                    </div>
    ...
    <!-- <script>
        // Datos para el segundo ComboBox basado en la selección del primero
        const datosCBOSubPartida = {
            <?php foreach ($cboPartida as $value) : ?> '<?php echo $value['id']; ?>': <?php echo isset($value['subpartidas']) ? json_encode($value['subpartidas']) : '[]'; ?>
            <?php endforeach ?>
        };

        // Función para cargar datos en el ComboBox de subpartidas
        function cargarSubPartidas() {
            const seleccionTipoPartida = document.getElementById("tipo_partida").value;
            const cboSubPartida = document.getElementById("tipo_subpartida");
            cboSubPartida.innerHTML = "";

            // Verificar si la clave 'subpartidas' está definida en los datosCBOSubPartida
            if (datosCBOSubPartida[seleccionTipoPartida] && Array.isArray(datosCBOSubPartida[seleccionTipoPartida])) {
                datosCBOSubPartida[seleccionTipoPartida].forEach(subPartida => {
                    const nuevaOpcion = document.createElement("option");
                    nuevaOpcion.value = subPartida;
                    nuevaOpcion.textContent = subPartida;
                    cboSubPartida.appendChild(nuevaOpcion);
                });
            }
        }

        // Inicialmente carga los datos del ComboBox de subpartidas
        cargarSubPartidas();
    </script> -->
</body>
