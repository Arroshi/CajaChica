...
<body>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Listado de los adicionales</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <form class="card-header p-0">
                                <div class="form-row card-body">
                                    <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                        ...
                                        <select class="form-control" id="id_caja_cstm_adic" name="id_caja_cstm_adic">
                            ...
                            <?php
                            require_once('../Controller/controller_selector.php');
                            $list_ingresoDetails = $oCaja->cajaIngresoDetails();
                            ?>
                            ...
                            <div id="diff_" class="card-body">
                                <table id="table" class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <?php foreach ($list_ingresoDetails as $lst_dtls) :
                                            $cont = 0;
                                        ?>

                                            <tr>
                                                <?php showdata($lst_dtls[$cont++]) ?>
                                                <?php showdata($lst_dtls[$cont++]) ?>
                                                <?php showdata("S/. " . $lst_dtls[$cont++]) ?>
                                                <?php showdata($lst_dtls[$cont++]) ?>
                                            </tr>
                                        <?php endforeach ?>
                                    </tbody>
    ...
    <script>
        $(document).ready(function() {
            ...
            // $('#id_caja_cstm_adic').change(function() {
            //     if ($('#id_caja_cstm_adic').val() == 'Selecciona') {
    ...
    <script>
        $("#id_caja_cstm_adic").change(function() {
            var _data_diff_ing = {
                id_caja_cstm_adi: true,
                id_caja_cstm_adic: $("#id_caja_cstm_adic").val(),
            };
