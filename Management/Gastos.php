        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h3 class="card-header">Registro de Tipos de Gastos</h3>
                            <div class="card-body">
                                <form method="POST" id="save_tipo_gasto">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="desc_gasto" name="desc_gasto" placeholder="Describa el tipo de gasto" aria-describedby="inputGroupPrepend" required>
                                            </div>
                                        </div>


                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                            <button class="btn btn-primary" id="btn_save_gasto" name="btn_save_gasto" type="submit">Crear</button>
                                        </div>
                                    </div>
                                </form>
