        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h3 class="card-header">Registro de Centro de Costos</h3>
                            <div class="card-body">
                                <form method="POST" id="save_centro_c">

                                    <div class="form-row">
                                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2 form-group">
                                            <label for="validationCustomUsername">Identificador</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="inputGroupPrepend">#</span>
                                                </div>
                                                <input type="text" class="form-control" id="identif_centro" name="identif_centro" placeholder="Cree un identificador" aria-describedby="inputGroupPrepend" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="desc_centro" name="desc_centro" placeholder="Describa el centro de costos" aria-describedby="inputGroupPrepend" required>
                                            </div>
                                        </div>


                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                            <button class="btn btn-primary" id="btn_save_centro" name="btn_save_centro" type="submit">Crear</button>
                                        </div>
                                    </div>
                                </form>
