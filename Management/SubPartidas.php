        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h3 class="card-header">Registro de Sub Partidas</h3>
                            <div class="card-body">
                                <form method="POST">
                                    <div class="form-row">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12  mb-2 row">
                                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12  mb-2 form-group">
                                                <label for="part">Escoga Partida</label>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12  mb-2 row">
                                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12  mb-2 form-group">
                                                <label for="nomPart">Nueva sub partida</label>
                                                <input type="text" class="form-control" id="nomPart" name="nomPart" placeholder="Ingrese la nueva sub partida" required>
                                            </div>
                                        </div>
