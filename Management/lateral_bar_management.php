        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav flex-column">
                    ...
                    <?php if ($_SESSION['roles'] === 1 || $_SESSION['roles'] === 2 || $_SESSION['roles'] === 4) { ?>
                        ...
                        <li class="nav-item">
                            ...
                            <div id="submenu-2" class="collapse submenu">
                                ...
                                <?php if ($_SESSION['roles'] === 1 || $_SESSION['roles'] === 2) { ?>
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="../Caja/AperturaCaja.php">Apertura de Caja</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="../Caja/CierreCajaFinal.php">Validacion de Cierre de Caja</a>
                                        </li>
                                    </ul>
                                    <!-- CONTABILIDAD -->
                                <?php } ?>
                                ...
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="../Caja/ingreso.php">Caja</a>
                                    </li>
                                    <?php if ($_SESSION['user_'] === 'bamez') { ?>
                                        <li class="nav-item">
                                            <a class="nav-link" href="../Caja/ingresos.php">Registros manuales</a>
                                        </li>
                                    <?php } ?>
                                    <li class="nav-item">
